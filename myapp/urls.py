...
from .views import index, clientes, vendedores, productos, pedidos, proveedores, compras, detalle_cliente, detalle_vendedor, detalle_producto, detalle_pedido, detalle_proveedor
